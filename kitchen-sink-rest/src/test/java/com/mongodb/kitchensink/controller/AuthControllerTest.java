...
import com.mongodb.kitchensink.exception.GlobalExceptionHandler;
...
import static com.mongodb.kitchensink.constants.ErrorCodes.INVALID_CREDENTIALS;
...
class AuthControllerTest {
    ...
    void setUp() {
        ...
        mockMvc = MockMvcBuilders.standaloneSetup(authController)
                .setControllerAdvice(new GlobalExceptionHandler()) // if you have @ControllerAdvice
                .build();
    }
